...
function writeTemplate(filePath, content, force) {
...
function injectLoader(content, loader) {
    ...
    return normalizeTrailingNewline(content.slice(0, insertionIndex).trimEnd() + "\n\n" + loader.trimEnd() + "\n\n" + content.slice(insertionIndex).trimStart());
}
